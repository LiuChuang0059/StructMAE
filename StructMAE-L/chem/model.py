...
from graphmae_utils import create_activation
...
class MLP(nn.Module):
    ...
    def forward(self, x):
        ...
        for layer in range(self.num_layer):
            h = self.linears[layer](h_list[layer])
...
# class MLP(nn.Module): # 只用在scoreGenerator中
#     def __init__(self, num_hidden, num_layers, dropout):
#         super(MLP, self).__init__()
#         # self.in_dim = in_dim
#         in_dim = num_atom_type
